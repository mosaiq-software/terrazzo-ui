...
interface SearchObject_Projs extends SearchObject {
    object: Project;
}
interface SearchObject_Boards extends SearchObject {
    object: BoardRes;
}
interface SearchObject_Cards extends SearchObject {
    board: string;
    object: Card;
}
            ...
            userDash.organizations.map(async (organization) => {
                ...
                org_data.projects.map(async (project) => {
                    ...
                    project_data.boards.map(async (board) => {
                        ...
                        await Promise.all(
                            board_data.lists.map(async (list) => {
