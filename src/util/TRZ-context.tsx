...
type TRZContextType = {
    ...
    openedSprintReport: boolean;
    setOpenedSprintReport: React.Dispatch<React.SetStateAction<boolean>>;
}
...
const TRZProvider: React.FC<any> = ({ children }) => {
    ...
    const [openedSprintReport, setOpenedSprintReport] = useState<boolean>(false);
